                        ...
                        <div class="breadcrumb-nav breadcrumb-nav-color--black breadcrumb-nav-hover-color--golden">
                            <nav aria-label="breadcrumb">
                                <ul>
                                    ...
                                    <li class="active" aria-current="page">{{ $data->ten_sp }}</li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="col-xl-7 col-lg-6">
                    <div class="product-details-content-area product-details--golden" data-aos="fade-up"
                        ...
                        <div class="product-details-text">
                            ...
                            <div class="price">
                                @if ($data->gia_km == 0)
                                    <span class="price">{{ number_format($data->gia, 0, ',', '.') }} ₫</span>
                                @else
                                    <span class="price">
                                        <b class="text-danger">
                                            {{ number_format($data->gia_km, 0, ',', '.') }} ₫
                                        </b>
                                        <del>{{ number_format($data->gia, 0, ',', '.') }}</del>
                                    </span>
                                @endif
                            </div>
                            <p>>>CODE mô tả<< </p>
                                    <h1>{{ $ProductDetails->ram }}</h1>
                                    ...
                                    <div class="single-tab-content-item">
                                        <table class="table table-bordered mb-20">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th scope="row">ROM</th>
                                                    <td>{{ $ProductDetails->Dia }}</td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">Color</th>
                                                    <td>{{ $ProductDetails->Mausac }}</td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">Height</th>
                                                    <td>{{ $ProductDetails->Cannang }} Kg</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        <p>>>CODE mô tả<< </p>
