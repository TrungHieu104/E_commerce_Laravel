    ...
    <div class="breadcrumb-section breadcrumb-bg-color--golden">
        <div class="breadcrumb-wrapper">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h3 class="breadcrumb-title">Collections - " {{$ten}}"</h3>
            ...
            <div class="row flex-column-reverse flex-lg-row">
                ...
                <div class="col-lg-9">
                                ...
                                <div class="sort-box d-flex justify-content-between align-items-md-center align-items-start flex-md-row flex-column"
                                    ...
                                    <div class="page-pagination text-center">
                                        <div class="showing-info">
                                            Showing {{ $listCate->firstItem() }} to {{ $listCate->lastItem() }} of {{ $listCate->total() }} products
                                        </div>
                                        <ul class="pagination">
                                                        ...
                                                        <div class="product-default-single-item product-color--golden"
                                                            ...
                                                            <div class="content">
                                                                <div class="content-left">
                                                                    ...
                                                                    @if ($dt->gia_km == 0)
                                                                        <span
                                                                            class="price">{{ number_format($dt->gia, 0, ',', '.') }} ₫</span>
                                                                    @else
                                                                        <span class="price">
                                                                            <b class="text-danger">
                                                                ...
                                                                <div class="content-right">
                                                                    @if ($dt->gia_km != 0)
                                                                    <div class="badge text-wrap" style=" width: 3rem; background:#dc3545;">
                                                                        sale
                                                                    </div>
                                                                    @endif
                                                                </div>
                                                    ...
                                                    <div class="product-list-single product-color--golden">
                                                        ...
                                                        <div class="product-list-content">
                                                            <h5 class="product-list-link"><a
                                                                    href="product-details-default.html">{{$dt->ten_sp}}</a></h5>
                    ...
                    <div class="page-pagination text-center">
                        <ul class="pagination">
                            <!-- Previous Page Link -->
                            @if ($listCate->onFirstPage())
                                <li class="page-item disabled"><span class="page-link">&laquo;</span></li>
                            @else
                                <li class="page-item"><a class="page-link" href="{{ $listCate->previousPageUrl() }}">&laquo;</a></li>
                            @endif
                    
                            <!-- Pagination Elements -->
                            @foreach ($listCate->onEachSide(1)->links()->elements as $element)
                            ...
                            <!-- Next Page Link -->
                            @if ($listCate->hasMorePages())
                                <li class="page-item"><a class="page-link" href="{{ $listCate->nextPageUrl() }}">&raquo;</a></li>
                            @else
